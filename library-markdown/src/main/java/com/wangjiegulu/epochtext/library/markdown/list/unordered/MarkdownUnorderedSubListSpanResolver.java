...
/**
 * https://stackoverflow.com/questions/31142017/solving-the-empty-bulletspan
 * https://stackoverflow.com/questions/26399111/android-edittext-how-to-create-an-empty-bullet-paragraph-by-bulletspan
 *
 * Author: wangjie
 ...
 */
@Deprecated
public class MarkdownUnorderedSubListSpanResolver extends BaseSpanResolver<String>{
    private static final String TAG = MarkdownUnorderedSubListSpanResolver.class.getSimpleName();
